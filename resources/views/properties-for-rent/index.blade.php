...
<div class="container mt-4">
    ...
    <div class="col-md-6">
        ...
        <form action="{{ route('properties-for-rent.index') }}" method="GET" class="d-flex">
            <input 
                type="text" 
                name="search" 
                class="form-control" 
    ...
    <div class="col-md-6">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{ route('properties-for-rent.create') }}" class="btn">
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $home->name }}</td>
            <td>{{ $home->user->name ?? 'N/A' }}</td> <!-- Owner name from the user relation -->
            <td>{{ $home->location ?? 'N/A' }}</td> <!-- Property location -->
            <td>
                <a href="{{ route('properties-for-rent.edit', $home->id) }}" class="btn">
